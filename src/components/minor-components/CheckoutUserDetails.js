...
export const CheckoutUserDetails = (props) => {
  ...
  // useEffect(() => {
  //   if (shops.length > 0) {
  //     setDeliveryCharges(shops.length > 0 ? shops[0].delivery : 0);
  //   }
  // }, [shops])
  
  // useEffect(() => {
  //   if (deliveryCharges !== 0) {
  //     const total = parseInt(props.totalPrice) + parseInt(deliveryCharges);
  //     setTotalPrice(total)
  //   }
  // },[deliveryCharges])
  ...
  const handleSubmit = async (e) => {
    ...
    const coordinates = [lngs, lats]
    props.handleSubmit(selected, props.totalPrice, deliveryCharges, address, postalCode, paymentMethod, coordinates);
    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        <div >
          ...
          <PaymentMethods
            value='Zelle Kye Rodriguez 657-258-7390'
            text='Zelle Kye Rodriguez 657-258-7390'
            // icon={SameDayDelivery}
            changeCheck={changeCheck}
            selected={selected === "Zelle Kye Rodriguez 657-258-7390" ? true : false}
          />

          <PaymentMethods
            value='Venmo @kye-Rodriguez Last 4 digits of phone number 7390'
            text='Venmo @kye-Rodriguez Last 4 digits of phone number 7390'
            changeCheck={changeCheck}
            // icon={Mailorderdelivery}
            selected={selected === "Venmo @kye-Rodriguez Last 4 digits of phone number 7390" ? true : false}
          />
          <PaymentMethods
            value='Apple cash  657-258-7390'
            text='Apple cash  657-258-7390'
            changeCheck={changeCheck}
            // icon={Mailorderdelivery}
            selected={selected === "Apple cash  657-258-7390" ? true : false}
          />
          <PaymentMethods
            ...
            changeCheck={changeCheck}
            // icon={Mailorderdelivery}
            selected={selected === "Cash on delivery" ? true : false}
          />
